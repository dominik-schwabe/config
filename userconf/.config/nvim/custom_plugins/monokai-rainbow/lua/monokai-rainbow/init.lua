...
HL.syntax = {
  ...
  CurSearch = { fg = C.base3, bg = C.orange },
  ...
  CursorLineNr = { fg = C.orange, bg = C.base3 },
  ...
  Folded = { fg = C.grey, bg = C.base4 },
  Ignore = {},
  IncSearch = { fg = C.base3, bg = C.orange },
  LineNr = { bg = "none" },
  Macro = { fg = S.macro },
  MatchParen = { bg = C.match_paren, fg = "black" },
  Normal = { bg = C.base0 },
  NormalFloat = { bg = C.base0 },
  Pmenu = { fg = C.base11, bg = C.black },
  PmenuSbar = { bg = C.base4 },
  PmenuSel = { bg = C.base5, bold = true },
  PmenuSelBold = { fg = C.base5, bg = C.orange },
  PmenuThumb = { bg = C.orange_alt },
  PmenuKind = { fg = C.green },
  PmenuExtra = { fg = C.purple },
  PreCondit = { fg = C.pink },
  Question = { fg = C.yellow, bold = true },
  QuickFixLine = { fg = C.yellow, bold = true },
  Search = { fg = C.base3, bg = C.gold },
  SignColumn = { bg = "none" },
  ...
  Statement = { fg = C.pink },
  StatusLine = { fg = C.base10, bg = C.base4 },
  StatusLineNC = { fg = C.grey, bg = C.base4 },
  TabLineFill = {},
  TabLineSel = { bg = C.base5 },
  Tabline = {},
  Terminal = { fg = C.white, bg = C.base3 },
  VertSplit = { fg = C.brown },
  Visual = { bg = C.visual },
  VisualNOS = { bg = C.base4 },
  Whitespace = { fg = C.base6 },
  WildMenu = { fg = C.white, bg = C.orange },
  debugBreakpoint = { fg = C.base3, bg = C.red },
...
HL.lsp = {
  ...
  LspInlayHint = { fg = C.white, bg = C.dark_purple },
  NvimDapViewVirtualText = { fg = C.white, bg = C.dark_orange },
}
...
HL.blink = {
  ...
  BlinkCmpLabelDetail = { fg = C.fn },
  BlinkCmpLabelDescription = { fg = C.link, bold = true },
  BlinkCmpKindClass = { link = "@constructor" },
  BlinkCmpKindColor = { fg = C.orange },
  BlinkCmpKindConstant = { link = "@constant" },
  BlinkCmpKindConstructor = { link = "@constructor" },
  BlinkCmpKindDefault = { fg = C.white },
  BlinkCmpKindEnum = { fg = S.enum },
  BlinkCmpKindEnumMember = { fg = S.enum_member },
  BlinkCmpKindEvent = { fg = S.event },
  BlinkCmpKindField = { fg = S.field },
  BlinkCmpKindFile = { fg = S.file },
  BlinkCmpKindFolder = { fg = S.folder },
  BlinkCmpKindFunction = { fg = S.function_call },
  BlinkCmpKindInterface = { fg = S.type },
  BlinkCmpKindKeyword = { fg = S.keyword },
  BlinkCmpKindMethod = { fg = S.method },
  BlinkCmpKindModule = { fg = S.import },
  BlinkCmpKindOperator = { fg = S.operator },
  BlinkCmpKindProperty = { fg = S.property },
  BlinkCmpKindReference = { fg = S.reference },
  BlinkCmpKindSnippet = { fg = S.snippet },
  BlinkCmpKindStruct = { link = "@constructor" },
  ...
  BlinkCmpKindYank = { fg = C.purple_alt, bold = true },
  BlinkCmpKindPath = { fg = S.folder },
  BlinkCmpKindTmux = { fg = C.yellow },
  BlinkCmpKindVersion = { fg = C.green_alt2 },
...
HL.other = {
  ...
  BoldOlive = { fg = C.green_alt, bold = true },
  BoldAqua = { fg = C.aqua, bold = true },
  BoldBlue = { fg = C.fn, bold = true },
  BoldWhite = { fg = C.white, bold = true },
  BoldGrey = { fg = C.grey, bold = true },
  YankHighlight = { bg = C.dark_purple },
  FidgetNormal = { bg = C.base4, fg = "#00ff00", bold = true },
  FidgetDone = { fg = C.base7 },
  FidgetGroup = { fg = C.white },
  FidgetProgress = { fg = "#ffff00" },
  FlashMatch = { fg = C.white, bg = C.base6 },
  FlashCurrent = { fg = C.white, bg = C.base6 },
  ...
  TreesitterContext = { bg = C.base4 },
  TreesitterContextLineNumber = { bg = C.base4 },
