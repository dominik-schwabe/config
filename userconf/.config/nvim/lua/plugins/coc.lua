...
g.coc_global_extensions = { 'coc-clangd', 'coc-css', 'coc-emmet', 'coc-docker', 'coc-html', 'coc-java', 'coc-json', 'coc-prettier', 'coc-pyright', 'coc-r-lsp', 'coc-sh', 'coc-snippets', 'coc-tsserver', 'coc-ultisnips', 'coc-vimlsp', 'coc-vimtex', 'coc-yaml' }
