...
vim.keymap.set("n", "<leader>od", F.cb(show_diagnostics, true), { desc = "show buffer diagnostics in quickfix" })
vim.keymap.set("n", "<leader>ow", F.cb(show_diagnostics, false), { desc = "show workspace diagnostics in quickfix" })
