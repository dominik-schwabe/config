...
hl.treesitter = {
  ...
  ["@text.strong"] = { fg = palette.neon_purple },
  ["@text.emphasis"] = { fg = palette.neon_purple },
  ["@text.underline"] = { fg = palette.neon_purple },
  ["@text.strike"] = { fg = palette.neon_purple },
  ["@text.title"] = { fg = palette.neon_purple },
  ["@text.literal"] = { fg = palette.neon_purple },
  ["@text.uri"] = { fg = palette.neon_purple },
  ["@text.math"] = { fg = palette.neon_purple },
  ["@text.environment"] = { fg = palette.neon_purple },
  ["@text.environment.name"] = { fg = palette.neon_purple },
  ["@text.note"] = { fg = palette.neon_purple },
  ["@text.warning"] = { fg = palette.neon_purple },
  ["@text.danger"] = { fg = palette.neon_purple },
  ["@todo"] = { fg = palette.neon_purple },
  ["@type"] = { fg = palette.aqua },
  ["@type.builtin"] = { fg = palette.bright_purple },
