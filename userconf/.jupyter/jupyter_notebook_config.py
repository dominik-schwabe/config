...
c.LanguageServerManager.extra_node_roots = [os.path.expanduser("~/.local/lib/")]
...
#  Choices: any of ['sha256', 'sha3_224', 'blake2s', 'sha384', 'sha512', 'md5', 'sha3_256', 'sha3_512', 'blake2b', 'sha3_384', 'sha224', 'sha1']
#  Default: 'sha256'
