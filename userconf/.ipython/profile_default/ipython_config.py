...
def get_installed_extensions(*extensions: str) -> list[str]:
    installed_extensions: list[str] = []
    missing_extensions: list[str] = []
    for e in extensions:
        if importlib.util.find_spec(e):
            installed_extensions.append(e)
        else:
            missing_extensions.append(e)
...
c.InteractiveShellApp.extensions = [
    "autoreload",
    *get_installed_extensions("ipython_autoimport"),
]
